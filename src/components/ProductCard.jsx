...
ProductCard.propTypes = {
  image: PropTypes.string.isRequired, // Example: image should be a string and is required
  ...
  id: PropTypes.string.isRequired,   // Example: id should be a string and is required
};
