...
const Wishlist = () => {
  ...
  const { clearWishlist, total } = useContext(WishlistContext);
      ...
      {isAuthenticated ? (
        <div className="container">
          ...
          <div className="d-flex justify-content-between">
            ...
            {total > 0 && (
              <Button handleClick={() => clearWishlist()}>Clear Wishlist</Button>
            )}
          </div>
        </div>
      ) : (
        <Button className="mx-auto d-flex" handleClick={() => navigate("/login")}>
          Login
        </Button>
      )}
    </>
